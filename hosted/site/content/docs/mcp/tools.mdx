...
| --- | --- | --- |
| `access` | string | read, deploy or full; defaults to what the key calling this has |
| `name` * | string | a label to recognize this key by later, e.g. "mcp" or "laptop" |
| `projects` | array | project slugs the key is held to; omitted means every project the key calling this reaches |
