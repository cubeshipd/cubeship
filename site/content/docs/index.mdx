...
<Cards>
  <Card title="Install" href="/docs/install" description="One command on the server, as root." />
  <Card title="First five minutes" href="/docs/first-five-minutes" description="Claim the instance and give it a domain." />
  <Card title="Deploy an app" href="/docs/deploy-an-app" description="Push an image, run one from anywhere, or build from Git." />
