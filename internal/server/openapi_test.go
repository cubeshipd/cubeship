...
func TestDocumentedSurfaceIsTheProductAPI(t *testing.T) {
	...
	want := []string{
		...
		"DELETE /orgs/{orgSlug}/registries/{id}/images",
		"DELETE /orgs/{orgSlug}/registries/{id}/repositories",
		"DELETE /orgs/{orgSlug}/registry/images",
		"DELETE /orgs/{orgSlug}/registry/repositories",
		"GET /apps",
		...
		"GET /orgs",
		"GET /orgs/{orgSlug}/dns",
		"GET /orgs/{orgSlug}/dns/{id}/records",
		"GET /orgs/{orgSlug}/dns/{id}/status",
		"GET /orgs/{orgSlug}/dns/{id}/zones",
		"GET /orgs/{orgSlug}/github",
		"GET /orgs/{orgSlug}/github/branches",
		"GET /orgs/{orgSlug}/github/repositories",
		...
		"GET /orgs/{orgSlug}/registries/{id}/images",
		"GET /orgs/{orgSlug}/registries/{id}/repositories",
		"GET /orgs/{orgSlug}/registries/{id}/status",
		"GET /orgs/{orgSlug}/registries/{id}/usage",
		"GET /orgs/{orgSlug}/registry/images",
		"GET /orgs/{orgSlug}/registry/repositories",
		"GET /settings",
		"GET /users/me",
		...
		"PATCH /orgs/{orgSlug}/projects/{projectSlug}/environments/{envSlug}",
