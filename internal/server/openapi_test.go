...
func TestDocumentedSurfaceIsTheProductAPI(t *testing.T) {
	...
	want := []string{
		...
		"DELETE /datastores/{project}/{env}/{name}",
		"DELETE /datastores/{project}/{env}/{name}/attachments/{app}",
		"DELETE /datastores/{project}/{env}/{name}/expose",
		"DELETE /dns/{id}",
		...
		"GET /datastores/{project}/{env}/{name}",
		"GET /datastores/{project}/{env}/{name}/credentials",
		"GET /dns",
		"GET /dns/{id}/records",
		"GET /dns/{id}/status",
		"GET /dns/{id}/zones",
		...
		"PATCH /datastores/{project}/{env}/{name}",
		"PATCH /dns/{id}",
		...
		"POST /datastores",
		"POST /datastores/{project}/{env}/{name}/attachments",
		"POST /datastores/{project}/{env}/{name}/expose",
		"POST /dns",
		"POST /github",
		"POST /projects",
