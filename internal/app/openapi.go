			...
			appPath: {
				"patch": {
					...
					Responses: openapi.Responses{
						...
						"400": openapi.TextResponse("Nothing to change, a source the daemon cannot act on, a health check path that is not one, or a limit smaller than the smallest one that means anything (0.01 of a core, 6MiB of memory)."),
						"401": openapi.Unauthorized,
						"403": openapi.Forbidden,
