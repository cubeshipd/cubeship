...
// Limits is what one copy of an app may take. An alias rather than a
// type of its own: a database's ceiling is the same idea, and the two
// modules meet on it without either importing the other.
