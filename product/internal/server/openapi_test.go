...
func TestDocumentedSurfaceIsTheProductAPI(t *testing.T) {
	...
	want := []string{
		...
		"DELETE /apps/{project}/{env}/{name}/tcp-ports/{portID}",
		...
		"DELETE /datastores/{name}/backups/schedule",
		...
		"DELETE /github/{id}",
		"DELETE /instance/backups/schedule",
		"DELETE /nodes/{name}",
		"DELETE /objectstores/{name}",
		"DELETE /objectstores/{name}/attachments/{project}/{env}/{app}",
		"DELETE /objectstores/{name}/buckets/{bucket}",
		"DELETE /objectstores/{name}/buckets/{bucket}/folders",
		"DELETE /objectstores/{name}/buckets/{bucket}/objects",
		...
		"GET /apps/{project}/{env}/{name}/tcp-ports",
		"GET /apps/{project}/{env}/{name}/volumes",
		"GET /apps/{project}/{env}/{name}/volumes/{volumeID}/backups",
		"GET /apps/{project}/{env}/{name}/volumes/{volumeID}/backups/schedule",
		"GET /audit",
		"GET /backups",
		...
		"GET /datastores/{name}",
		"GET /datastores/{name}/backups",
		"GET /datastores/{name}/backups/schedule",
		...
		"GET /instance/backups/schedule",
		"GET /instance/containers",
		...
		"GET /objectstores/{name}/buckets",
		"GET /objectstores/{name}/buckets/{bucket}/download",
		...
		"GET /roles",
		"GET /settings",
		"GET /template-icons/{repository}/{file}",
		"GET /template-installs",
		"GET /template-installs/{id}",
		"GET /template-installs/{id}/update",
		"GET /template-tags",
		"GET /templates",
		...
		"POST /objectstores/{name}/buckets/{bucket}/folders",
		"POST /objectstores/{name}/expose",
		"POST /objectstores/{name}/start",
		"POST /objectstores/{name}/stop",
		"POST /projects",
		...
		"POST /template-installs/{id}/uninstall",
		"POST /template-installs/{id}/update",
		"POST /templates/{owner}/{repo}/installs",
		"POST /updates",
		"POST /users",
		"POST /users/{username}/password",
		"PUT /apps/{project}/{env}/{name}/env",
		"PUT /apps/{project}/{env}/{name}/volumes/{volumeID}/backups/schedule",
		"PUT /datastores/{name}/backups/schedule",
		"PUT /dns/{id}/records",
		"PUT /firewall/rules/{index}",
		"PUT /instance/backups/schedule",
	...
	wantInternal := []string{
		...
		"GET /apps/{project}/{env}/{name}/shell",
		"GET /docs",
		"GET /healthz",
		"GET /nodes/agent/shell/{id}",
		"GET /nodes/{name}/shell",
		"GET /openapi.json",
		"GET /setup",
