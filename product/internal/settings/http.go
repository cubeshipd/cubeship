...
type Response struct {
	...
	// BetaVersions says the update check offers betas and release
	// candidates too.
	BetaVersions bool `json:"beta_versions"`
...
func toResponse(v Values, publicIP string) Response {
	...
	r.BetaVersions = v.Get(BetaVersions) == "true"
...
func (h *Handler) set(w http.ResponseWriter, r *http.Request) {
	...
	if req.BetaVersions != nil {
		values[BetaVersions] = ""
		if *req.BetaVersions {
			values[BetaVersions] = "true"
		}
	}
