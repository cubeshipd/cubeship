	...
	return openapi.Spec{
		...
		Schemas: map[string]*openapi.Schema{
			"Settings": openapi.Object(map[string]*openapi.Schema{
				...
				"beta_versions":        openapi.Bool("Whether the update check offers beta versions — betas and release candidates — as well as stable releases. Automatic updating stays on stable releases either way."),
			...
			"/settings": {
				...
				"put": {
					...
					RequestBody: openapi.Body(openapi.Object(map[string]*openapi.Schema{
						...
						"beta_versions":         openapi.Bool("Offer beta versions — betas and release candidates — as well as stable releases when checking for an update. Off by default.\n\n**It changes what is offered and nothing else.** Automatic updating stays on stable releases, and turning this off on a beta never goes back a version: the instance stays until a stable release above it exists."),
